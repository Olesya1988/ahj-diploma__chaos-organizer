...
Ссылки на Интернет-страницы кликаельны и отображаются, как гиперссылки.
...
Для прикрепления файла нужно нажать на кнопку "Скрепка" справа от поля ввода. Появится окно для выбора файла. Выбираем файл, повляется превью под полем ввода. Если мы ошиблись, можно через крестик удалить припленный файл и загрузить новый. Если всё ок, нажимаем enter и файл уходит в список постов.
...
Скачиваем файл, кликнув на его название.


## 9. Поиск

Мы можем найти пост по ключевому слову. Вверху страницы есть поле поиска. Вносим туда слово, нажимаем enter. 
...
Мы можем поменять статус пользователя. Например, на "Отошёл" или "Не беспокоить". Для этого нажимаем на аватарку пользователя в правом верхнем углу. Из списка выбираем нужный статус.
